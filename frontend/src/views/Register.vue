...
const handleRegister = async () => {
  ...
  try {
    ...
    showAlertMessage(response.data.message || 'Registrasi berhasil', 'success')
    ...
    const errorMessage = error.response?.data?.error || error.response?.data?.message || "Registrasi gagal. Silakan coba lagi."
